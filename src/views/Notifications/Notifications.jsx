  ...
  return (
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>LOAN</h4>
            <p className={classes.cardCategoryWhite}>
              LOAN PACKAGES
            </p>
          </CardHeader>
          <CardBody>
            ...
            tableHeaderColor="primary"
              tableHead={["ID", "Package", "Amount", "Interest", "Payable"]}
              tableData={[
                ["1", "Silver", "GHS 36,738", "5%", "GHS40,000"],
                ["2", "Gold", "GHS 23,789", "6%", "GHS40,000"],
                ["3", "Diamond", "GHS 56,142", "2%", "GHS40,000"],
              ]}
            />
          </CardBody>
        </Card>
